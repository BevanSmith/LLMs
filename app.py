...
def get_conversation_chain(vectorstore):
    llm = HuggingFaceHub(repo_id ="google/flan-t5-base", model_kwargs={"temperature":0.0, "max_length":256})
...
def main():
    ...
    user_question = st.text_input("Ask me anything about PDFs and I will try to help you out!")
    if user_question:
    ...
    with st.sidebar:
        ...
        if st.button("Process "):
            ...
            # get the pdf text
                ...
                #st.write(raw_text)  #just put this in when you want to see it in the app
